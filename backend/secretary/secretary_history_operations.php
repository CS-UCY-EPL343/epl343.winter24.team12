...
<body>
    ...
    <div class="sidebar">
        <a href="secretary_dashboard.php" title="Dashboard">
        ...
        <i class="fas fa-stethoscope"></i> Operations <i class="fas fa-chevron-down dropdown-arrow"></i>
            ...
            <div class="dropdown-content">
                <a href="secretary_operations.php" title="Add New">> Add New</a>
                <a href="secretary_history_operations.php" title="History" style = "color: #ffc107;">> History</a>
            </div>
        </div>
    ...
    <div class="dashboard-container">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2 hours</td>
                        <td>Dr. Smith</td>
                        <td><a href="secretary_reports.php" class="view-report-btn"><i class="fas fa-file-alt"></i></a></td>
                        </tr>
                    <tr>
                        <td>2</td>
                        <td>Jane Doe</td>
            ...
            <button class="create-report-btn" onclick="location.href='secretary_reports.php'">CREATE REPORT FOR ALL</button>
        </div>
    </div>
