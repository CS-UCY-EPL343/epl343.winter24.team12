...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="nurse_operations.php" class="active" title="Operations" onclick="toggleDropdown(event)" style="background-color: #ffc107; color: #1a4f6e; font-size: 18px; font-weight: bold; padding: 10px; border-radius: 5px;">
        <i class="fas fa-stethoscope"></i> Operations <i class="fas fa-chevron-down dropdown-arrow"></i>
        </a>
            <div class="dropdown-content">
                <a href="nurse_operations.php" title="Add New">> Add New</a>
                <a href="nurse_history_operations.php" title="History" style = "color: #ffc107;">> History</a>
            </div>
        </div>
        ...
        <a href="nurse_users.php" title="Users">
    ...
    <div class="dashboard-container">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2 hours</td>
                        <td>Dr. Smith</td>
                        <td><a href="nurse_reports.php" class="view-report-btn"><i class="fas fa-file-alt"></i></a></td>
                        </tr>
                    <tr>
                        <td>2</td>
                        <td>Jane Doe</td>
            ...
            <button class="create-report-btn" onclick="location.href='nurse_reports.php'">CREATE REPORT FOR ALL</button>
        </div>
    </div>
