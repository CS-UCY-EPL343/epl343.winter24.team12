...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="doc_inventory.php" class="active" title="Inventory"><i class="fas fa-boxes"></i> Inventory</a>
        <a href="doc_operations.php" title="Operations"><i class="fas fa-stethoscope"></i> Operations</a>
        <a href="doc_supplier.php" title="Suppliers"><i class="fas fa-truck"></i> Suppliers</a>
        <a href="doc_reports.php" title="Reports"><i class="fas fa-chart-line"></i> Reports</a>
        <a href="doc_users.php" title="Users"><i class="fas fa-users"></i> Users</a>
        <a href="doc_settings.php" title="Settings"><i class="fas fa-cog"></i> Settings</a>
    </div>
