...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="admin_operations.php" class="active" title="Operations" onclick="toggleDropdown(event)" style="background-color: #ffc107; color: #1a4f6e; font-size: 18px; font-weight: bold; padding: 10px; border-radius: 5px;">
        <i class="fas fa-stethoscope"></i> Operations <i class="fas fa-chevron-down dropdown-arrow"></i>
        </a>
            <div class="dropdown-content">
                <a href="admin_operations.php" title="Add New">> Add New</a>
                <a href="admin_history_operations.php" title="History" style = "color: #ffc107;">> History</a>
            </div>
        </div>
    ...
    <div class="dashboard-container">
        ...
        <div class="table-container">
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2 hours</td>
                        <td>Dr. Smith</td>
                        <td><a href="admin_reports.php" class="view-report-btn"><i class="fas fa-file-alt"></i></a></td>
                        </tr>
                    <tr>
                        <td>2</td>
                        <td>Jane Doe</td>
            ...
            <button class="create-report-btn" onclick="location.href='admin_reports.php'">CREATE REPORT FOR ALL</button>
        </div>
    </div>
